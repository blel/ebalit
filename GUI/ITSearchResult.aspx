...
<asp:ObjectDataSource ID="odsITSearchResults" runat="server" SelectMethod="FindBlogEntries" TypeName="EbalitWebForms.BusinessLogicLayer.BlogEntryDAL">
        <SelectParameters>
    ...
    <div id="Container">
        ...
        <div id="MainColumn">
            <asp:DataList ID="dtlMusicSearchResults" runat="server" DataSourceID="odsITSearchResults" Width="775px" CellPadding="4" ForeColor="#333333">
