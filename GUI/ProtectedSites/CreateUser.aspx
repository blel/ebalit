<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/ProtectedSites/AdminMaster.master" AutoEventWireup="true" CodeBehind="CreateUser.aspx.cs" Inherits="EbalitWebForms.GUI.ProtectedSites.CreateUser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
    <div id="Container">
        <div id="LeftColumn"></div>
        <div id="MainColumn">
            <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" BackColor="#F7F7DE" BorderColor="#CCCC99" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="10pt" Width="760px">
                        ...
                        <WizardSteps>
                            <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server">
                                <ContentTemplate>
                                    <table style="font-family:Verdana;font-size:100%;width:760px;">
                                        <tr>
