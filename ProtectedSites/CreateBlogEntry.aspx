<%@ Page Title="" Language="C#" MasterPageFile="~/ProtectedSites/AdminMaster.master" AutoEventWireup="true" CodeBehind="CreateBlogEntry.aspx.cs" Inherits="EbalitWebForms.ProtectedSites.WebForm1" %>

<asp:Content runat="server" ContentPlaceHolderID="AdminContent" ID="ThisContent">

    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="EbalitWebForms.BlogEntry" DeleteMethod="DeleteBlogEntry" InsertMethod="CreateBlogEntry" SelectMethod="GetBlogEntry" TypeName="EbalitWebForms.BlogEntryDAL" UpdateMethod="UpdateBlogEntry" OnInserted="ObjectDataSource1_Inserted" OnSelecting="ObjectDataSource1_Selecting">
        <SelectParameters>
            <asp:Parameter DefaultValue="0" Name="Id" Type="Int32" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="odsBlogTopic" runat="server" SelectMethod="ReadBlogTopic" TypeName="EbalitWebForms.BlogTopicDAL" DataObjectTypeName="EbalitWebForms.BlogTopic" DeleteMethod="DeleteBlogTopic" InsertMethod="CreateBlogTopic" UpdateMethod="UpdateBlogTopic">
        <DeleteParameters>
