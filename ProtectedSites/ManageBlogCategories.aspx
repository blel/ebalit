<%@ Page Title="" Language="C#" MasterPageFile="~/ProtectedSites/AdminMaster.master" AutoEventWireup="true" CodeBehind="ManageBlogCategories.aspx.cs" Inherits="EbalitWebForms.ProtectedSites.WebForm4" %>

<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
    <asp:ObjectDataSource ID="odsBlogCategories" runat="server" SelectMethod="ReadBlogCategory" TypeName="EbalitWebForms.BlogCategoryDAL" DataObjectTypeName="EbalitWebForms.BlogCategory" DeleteMethod="DeleteBlogCategory" InsertMethod="CreateBlogCategory" UpdateMethod="UpdateBlogCategory"></asp:ObjectDataSource>
    <asp:ObjectDataSource ID="odsBlogTopics" runat="server" SelectMethod="ReadBlogTopic" TypeName="EbalitWebForms.BlogTopicDAL"></asp:ObjectDataSource>
